 ...
 * the default, then sequences of <space>, <tab>, and <newline> at the beginning
 ...
 * words. If IFS has a value other than the default, then sequences of the
 * whitespace characters space, tab, and newline are ignored at the beginning
 * and end of the word, as long as the whitespace character is in the value of
 * IFS (an IFS whitespace character). Any character in IFS that is not IFS
 * whitespace, along with any adjacent IFS whitespace characters, delimits a
 ...
 * That is, the word -d'' becomes -d after word splitting and null argument
 * removal.
 * 
 * <p/>
